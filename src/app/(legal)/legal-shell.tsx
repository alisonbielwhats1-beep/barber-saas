...
export function LegalShell({
  ...
  return (
    <main id="main-content" tabIndex={-1} style={{ padding: "var(--safe-top) var(--safe-right) var(--safe-bottom) var(--safe-left)" }} className="min-h-dvh bg-background outline-none">
      <MarketingHeader />
