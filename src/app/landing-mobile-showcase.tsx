...
function ClientHome() {
  return <div className="h-full bg-[#0e0f12] px-3 pt-10 text-[#f8f5ef]">
    ...
    <div className="relative mt-4 h-[145px] overflow-hidden rounded-[1.4rem]"><Image src="/images/salon-hero-stylist-v2.webp" alt="Espaço Aurora, estabelecimento demonstrativo" fill quality={95} sizes="280px" className="object-cover object-center" /><div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent" /><div className="absolute bottom-3 left-3"><span className="rounded-full bg-[#7df89b] px-2 py-1 text-[7px] font-bold text-black">MULTISSERVIÇOS</span><strong className="mt-1.5 block text-base">Espaço Aurora</strong><small className="text-[7px] text-white/75">Jardins · São Paulo</small></div></div>
